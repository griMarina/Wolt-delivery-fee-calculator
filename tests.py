...
def test_calculate_delivery_fee():
    # Example from the pre-assignment
    response = requests.post(url, json={'cart_value': 790, 'delivery_distance': 2235, 'number_of_items': 4, 'time': '2021-10-12T13:00:00Z'})
    result = response.json()
    assert result['delivery_fee'] == 710

    # Base fee is 2€ for the first 1km
    ...
    # If delivery distance is longer than 1km, extra fee is 1€ for each 500m. Extra fee is 3€ (1000m - 2€, 499m - 1€)
    ...
    # If cart value more than 100€ delivery fee equals is 0€
    ...
    # If number of items more than 4, extra fee is 0.5€ for each item
    ...
    # If number of items more than 12, extra 'bulk' is 1.2€
    ...
    # The delivery fee can never be more than 15€. Calculated delivery fee 2020 = 20.2€ (base_fee 200€ + small_cart_value_surcharge 500€ + add_distance_surcharge 400€ + add_items_surcharge 800€ + extra_surcharge 120€)
    ...
    # The delivery day is Friday and between 3 and 7 pm (1280 * 1.2 = 1536), but it could not be more than 15€ 
